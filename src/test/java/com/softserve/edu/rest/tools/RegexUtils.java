...
public final class RegexUtils {
    ...
    private final static String PATTERN_ALL_USERS_IN_ONE_LINE = "\\n+";
    ...
    public static String extractLineOfLockedUsers(String text){
        return text.replaceAll(PATTERN_ALL_USERS_IN_ONE_LINE,", ");
    }
}
