...
public class LogginedUsersResource extends RestQueries<SimpleEntity, SimpleEntity, SimpleEntity, SimpleEntity, SimpleEntity> {

    public LogginedUsersResource() {
            super(RestUrlRepository.getLogginedUsers(),
